...
Option.discriminators['score_prerequisite'] =
  new Schema<ScorePrerequisiteOption>({
...
OptionSetSchema.discriminators['equipment_category'] =
  new Schema<EquipmentCategoryOptionSet>({
    equipment_category: {
      type: APIReferenceSchema,
      index: true,
      required: true,
    },
  });

OptionSetSchema.discriminators['resource_list'] =
  new Schema<ResourceListOptionSet>({
    resource_list_url: { type: String, index: true, required: true },
  });

OptionSetSchema.discriminators['options_array'] =
  new Schema<OptionsArrayOptionSet>({
